...
export default function Home() {
  ...
  return (
    <div className="flex flex-col w-full bg-background min-h-screen">
      ...
      <section className="relative pt-32 pb-20 px-4 sm:px-8 md:px-16 bg-[#0A1628] bg-grid-pattern text-white overflow-hidden border-b-4 border-[#D62828]">
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start mb-16">
            <div className="lg:col-span-8 space-y-6">
              <span className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#D62828]/10 border border-[#D62828]/35 text-[#D62828] font-bold text-xs uppercase tracking-widest font-headline select-none">
                <span className="w-2 h-2 rounded-full bg-[#D62828] animate-pulse"></span>
                Authorized Channel Partner
              </span>
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black font-headline tracking-tighter leading-[0.95] text-white">
                REVOLUTIONIZING <br />
            ...
            <div className="lg:col-span-4 space-y-8 lg:pt-14">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 pt-8 border-t border-slate-800">
            <div className="bg-slate-900/40 backdrop-blur-sm border border-slate-800/80 p-6 rounded-lg hover:border-[#D62828]/40 transition-all duration-300 group">
      ...
      <section className="py-20 md:py-32 bg-white bg-grid-pattern relative" id="about">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 md:px-16 flex flex-col lg:flex-row gap-16 items-center">
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={idx} className="flex items-start gap-4">
                  <span className="material-symbols-outlined text-[#D62828] text-2xl shrink-0 select-none" style={{ fontVariationSettings: "'FILL' 1" }}>
                    check_circle
                  </span>
                  <span className="font-bold text-primary-container font-body text-base mt-0.5">
                    {text}
                  </span>
                </li>
              ))}
          ...
          <div className="w-full lg:w-1/2 relative flex justify-center">
            ...
            {/* Float Overlay Card */}
            <div className="absolute bottom-6 right-2 md:right-10 bg-primary-container text-white p-6 rounded-lg shadow-xl max-w-[240px] border border-slate-800">
              <span className="material-symbols-outlined text-[#D62828] text-4xl mb-3 select-none" style={{ fontVariationSettings: "'FILL' 1" }}>
                verified
              </span>
              <h4 className="font-headline font-bold text-lg mb-1 leading-tight">NABL Certified</h4>
              <p className="text-slate-400 text-xs font-body">Our services and equipment meet ISO/IEC 17025 calibration compliance guidelines.</p>
            </div>
          </div>
      ...
      <section className="py-20 md:py-32 bg-slate-50 relative" id="products">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 md:px-16 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-max">
            {featuredSolutions.map((item) => (
              ...
              >
                <div className={`relative ${item.height} w-full bg-slate-100 overflow-hidden`}>
                  <Image
                    alt={item.name}
      ...
      <section className="py-20 md:py-32 bg-white relative" id="services">
      ...
      {/* 6. Synergy Advantage Stats Banner */}
      <section className="py-20 md:py-28 bg-gradient-to-br from-[#0A1628] to-[#142846] text-white relative overflow-hidden border-t-4 border-b-4 border-[#D62828]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 md:px-16 relative z-10">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 text-center divide-y lg:divide-y-0 lg:divide-x divide-slate-800">
            ...
            <div className="space-y-2 pt-6 lg:pt-0">
              ...
              <h3 className="font-headline font-black text-3xl md:text-4xl text-white">10+ Years</h3>
              <p className="text-slate-400 text-xs md:text-sm font-body font-medium uppercase tracking-wider">Substation Audits</p>
            </div>
            ...
            <div className="space-y-2 pt-6 lg:pt-0">
              ...
              <h3 className="font-headline font-black text-3xl md:text-4xl text-white">87+ Models</h3>
              <p className="text-slate-400 text-xs md:text-sm font-body font-medium uppercase tracking-wider">Standard Products</p>
            </div>
            ...
            <div className="space-y-2 pt-6 lg:pt-0">
              ...
              <h3 className="font-headline font-black text-3xl md:text-4xl text-white">ISO 17025</h3>
              <p className="text-slate-400 text-xs md:text-sm font-body font-medium uppercase tracking-wider">NABL Calibration</p>
            </div>
            ...
            <div className="space-y-2 pt-6 lg:pt-0">
              ...
              <h3 className="font-headline font-black text-3xl md:text-4xl text-white">24/7 Care</h3>
              <p className="text-slate-400 text-xs md:text-sm font-body font-medium uppercase tracking-wider">Onsite Commissioning</p>
            </div>
      ...
      <section className="py-20 md:py-32 bg-slate-50 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 md:px-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white border border-slate-200 p-8 rounded-lg flex flex-col justify-between hover:shadow-xl hover:border-[#D62828]/30 transition-all duration-300">
            ...
            <div className="bg-white border-2 border-primary-container p-8 rounded-lg flex flex-col justify-between hover:shadow-xl relative shadow-md">
              {/* Highlight Tag */}
              ...
              {faqs.map((faq, idx) => (
                <div key={idx} className="border border-slate-200 rounded-lg bg-white overflow-hidden transition-shadow hover:shadow-sm">
                  <button
                    ...
                    className="w-full flex items-center justify-between p-6 text-left font-headline font-bold text-base md:text-lg text-primary-container focus:outline-none"
                  >
                  ...
                  >
                    <div className="p-6 pt-0 text-on-surface-variant font-body text-sm leading-relaxed border-t border-slate-100">
                      {faq.answer}
                    </div>
                  </div>
                </div>
      ...
      <section className="py-20 md:py-32 bg-slate-50 relative" id="blog">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 md:px-16">
      ...
      <section className="py-20 md:py-32 bg-white relative" id="contact">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 md:px-16 grid grid-cols-1 lg:grid-cols-12 gap-16 items-stretch">
          
          {/* Left Side: Solid Info Column */}
          <div className="lg:col-span-5 relative rounded-lg overflow-hidden flex flex-col justify-between p-8 md:p-12 text-white bg-[#0A1628] bg-grid-pattern border-b-4 border-[#D62828] shadow-xl">
            {/* Mesh Overlay */}
          ...
          <div className="lg:col-span-7 bg-slate-50 border border-slate-200 p-8 md:p-12 rounded-lg shadow-sm">
